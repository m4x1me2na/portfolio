...
import "@/styles/revealhero/revealherotest.scss"

gsap.registerPlugin(useGSAP, SplitText);

export default function RevealHeroTest({
                                       big,
                                       small,
                                       mid,
                                       delay = 0
    ...
    return (
        <section ref={root} className="animated-hero  flex flex-col  px-[10vw] py-[4vh]">
            ...
            <h1 className="ah-title"><span ref={bigRef}>{big}</span><span ref={dotRef}  id="dot">.</span></h1>

...
export default function ScrumbleTestMenu({
                                         text,
                                         href,
                                         isProjectPage = false,
                                         className = "",
    ...
    return (
        ...
        <span className="relative inline-flex cursor-pointer pointer-events-auto leading-none align-middle" cursor-scale={0.5}>
          <span className="relative inline-block h-[clamp(2.5rem,3vw,4rem)] overflow-hidden leading-none">
            {/* TOP LINE */}
              <span
                  aria-hidden="true"
                  className="absolute left-0 top-0 inline-flex whitespace-pre text-[var(--foreground)] leading-none font-semibold tracking-tight text-[clamp(2.5rem,3vw,4rem)]"
              >
              {/* ✅ SplitText UNIQUEMENT sur ce span */}
                ...
                <svg viewBox="0 0 27 27" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-[1ex] h-[1ex]">
                  <path
              ...
              {/* BOTTOM LINE */}
              <span
                  className="inline-flex whitespace-pre text-[var(--foreground)] leading-none font-semibold tracking-tight text-[clamp(2.5rem,3vw,4rem)]"
              >
              {/* ✅ SplitText UNIQUEMENT sur ce span */}
